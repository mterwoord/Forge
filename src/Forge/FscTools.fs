(*  Based on 
        FscHelper from FAKE - https://github.com/fsharp/FAKE/blob/master/src/app/FakeLib/FscHelper.fs
*)

module Forge.FscTools
...
type FscParams = 
    { /// Specifies the output file name and path.
      ...
      FscTarget : Fsc.TargetType
      /// Specifies the compiled artifact target platform.
      Platform : Fsc.PlatformType
