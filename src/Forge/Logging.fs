(*  Base on
        Logging.fs from Paket - https://github.com/fsprojects/Paket/blob/master/src/Paket.Core/Logging.fs
        TraceListener.fs from FAKE - https://github.com/fsharp/FAKE/blob/master/src/app/FakeLib/TraceListener.fs
*)

module Forge.Logging
